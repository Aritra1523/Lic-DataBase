...
Krishna Mohan Das (LICI)`;
 ...
 const getNextDueDate = (customer) => {
  ...
  const baseDate = customer.lastPaidDate || customer.EnrollmentDate;
            ...
            {filteredCustomers.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="p-4">{c.EnrollmentDate?.split("T")[0]}</td>
                  ...
                  <td className="p-4">
                    <a href={aadharURL} target="_blank" className="text-indigo-600 hover:underline">
                      View
                    </a>
                  </td>

                  <td className="p-4">
                    <a href={panURL} target="_blank" className="text-indigo-600 hover:underline">
                      View
                    </a>
                  </td>

                  <td className="p-4">
                    <a href={photoURL} target="_blank" className="text-indigo-600 hover:underline">
                      View
                    </a>
                  </td>

                  <td className="p-4">
                    <a href={bankURL} target="_blank" className="text-indigo-600 hover:underline">
                      View
                    </a>
                  </td>
